...
class ObstacleAvoidance(Node):
    ...
    def __init__(self):
        ...
        self.BLOCKING_TICKS = 25  # tiempo para que el planner genere nuevo path
        self.COOLDOWN_TICKS = 20  # para que el robot arranque a girar/avanzar
    ...
    def control_loop(self):
        ...
        # freno el robot frenado mientras el planner trabaja
        ...
        #control ya devuelto no redetectar aun
