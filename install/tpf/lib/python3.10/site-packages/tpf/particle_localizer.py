...
class ParticleLocalizer(Node):
    ...
    def __init__(self):
        ...
        self.landmark_sigma_dist = 0.40    #tolerancia en distancia al landmark
        self.landmark_sigma_bearing = 0.30 #tolerancia en bearing al landmark
        self.landmark_scale = 0.30
    ...
    def build_distance_field(self):
        ...
        for row in range(height):
            for col in range(width):
                ...
                # 0 es libre, 100 es ocupado, -1 es desconocido.
                if occ > 50 or occ == -1:
    ...
    def odom_callback(self, msg):
        ...
        movement_angle = math.atan2(dy, dx) if distance > 1e-6 else self.last_odom_yaw
